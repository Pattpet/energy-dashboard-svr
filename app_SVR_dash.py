...
# *** ODSTRANĚN KÓD PRO RÁMEČKY (CSS) ***

st.title("Energy Dashboard - SVR")
st.markdown("Vítejte v dashboardu pro analýzu dat z evropských energetických trhů.")
st.markdown("Data získána skrze entsoe-e")
...
if days_ago < 100: 
    st.sidebar.info("Pro aktuální a blízká data bude nabídková křivka RE aFRR vždy zobrazena pro hodinu 00:00 UTC, bez ohledu na výběr slideru. Slider ovlivňuje pouze Day-Ahead čáru a grafy kapacity.")
